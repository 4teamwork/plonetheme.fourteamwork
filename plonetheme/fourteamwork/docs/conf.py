...
project = u'plonetheme.fourteamwork'
...
htmlhelp_basename = 'plonetheme.fourteamworkdoc'
...
latex_documents = [
  ('index', 'plonetheme.fourteamwork.tex', u'plonetheme.fourteamwork Documentation',
   u'Hexagon IT', 'manual'),
]
...
man_pages = [
    (
        'index',
        'todo',
        u'plonetheme.fourteamwork Documentation',
        [u'Hexagon IT'],
        1)]
